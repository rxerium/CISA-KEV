...
### Overview
- **Total CVEs in KEV**: 1,614
- **Scannable with Nuclei**: 464 (28.7%)
- **With Public PoCs**: **985 (61.0%)**
- **Unscannable**: 1,150 (71.3%)
- **Ransomware-Associated**: 325 (20.1%)
- **Unique Vendors**: 265
- **Unique Products**: 653

### Key Insights
- 🎯 **Microsoft** is the most represented vendor with **377 CVEs**
- 🔍 **464 CVEs** can be actively scanned with Nuclei templates
- 💣 **985 CVEs** (61.0%) have public proof-of-concept exploits available
- 🎯 **394 CVEs** have both PoC and Nuclei template (fully testable)
- 🔓 **591 CVEs** have PoC but no Nuclei template (testing gap)
- 🦠 **325 CVEs** (20.1%) are known to be used in ransomware campaigns
