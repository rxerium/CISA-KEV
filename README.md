...
This repository provides automated tracking and analysis of both **CISA's KEV** and **VulnCheck KEV** catalogs, cross-referenced with Nuclei security templates and public proof-of-concept exploits. By integrating VulnCheck KEV, coverage expands from 1,557 to **4,720 total unique CVEs** - a **3x increase**. The combined dataset reveals that 36.1% of all KEV vulnerabilities can be actively scanned with Nuclei templates (1,702 CVEs). VulnCheck's extended coverage adds **3,163 additional vulnerabilities** not found in CISA's official list, providing comprehensive visibility into exploited vulnerabilities. With automated daily updates and dual-source intelligence, this repository delivers the most complete KEV tracking available.

**Quick Stats (Combined):** 4,720 total CVEs | 1,702 scannable with Nuclei | 3,163 VulnCheck-exclusive | 1,557 CISA KEV
...
|--------|----------|---------------|---------------------|
| **Total CVEs** | 1,557 | 4,720 | 4,720 unique |
| **Scannable with Nuclei** | 448 (28.8%) | 1,702 (36.1%) | 1,702 (36.1%) |
| **Overlap** | - | - | 1,557 (100% of CISA) |
| **Source-Exclusive CVEs** | 0 | 3,163 | - |
| **Coverage Increase** | - | - | **+203% more CVEs** |

### Key Insights
- ✅ **100% of CISA KEV vulnerabilities are included in VulnCheck KEV** (1,557 overlap)
- 🚀 **VulnCheck provides 3x more vulnerability coverage** (3,163 additional CVEs)
- 🔍 **1,702 CVEs can be actively scanned** with Nuclei templates (36.1% coverage)
- 📈 **+1,255 additional scannable CVEs** from VulnCheck vs CISA alone
- 🎯 VulnCheck's extended dataset captures vulnerabilities exploited in the wild but not yet on CISA's official list
- 🆕 **VulnCheck updated to 4,720 CVEs** (latest data from 2026-04-03)
...
- 1,557 CVEs with mandatory remediation deadlines
...
- 4,720 CVEs with verified exploitation evidence

### Nuclei Template Coverage by Source

| Source | Total CVEs | Scannable | Coverage % | Unscannable |
|--------|-----------|-----------|------------|-------------|
| **CISA KEV** | 1,557 | 448 | 28.8% | 1,109 |
| **VulnCheck KEV** | 4,720 | 1,702 | 36.1% | 3,018 |
| **VulnCheck-Exclusive** | 3,163 | 1,255 | 39.7% | 1,908 |

**Insight:** VulnCheck-exclusive CVEs have a higher Nuclei coverage rate (39.7%) compared to the overall dataset, suggesting strong community security tool support for these additional vulnerabilities.
...
### Overview
- **Total CVEs in KEV**: 1,568
- **Scannable with Nuclei**: 450 (28.7%)
- **With Public PoCs**: **985 (62.8%)**
- **Unscannable**: 1,118 (71.3%)
- **Ransomware-Associated**: 313 (20.0%)
- **Unique Vendors**: 257
- **Unique Products**: 636

### Key Insights
- 🎯 **Microsoft** is the most represented vendor with **368 CVEs**
- 🔍 **450 CVEs** can be actively scanned with Nuclei templates
- 💣 **985 CVEs** (62.8%) have public proof-of-concept exploits available
- 🎯 **394 CVEs** have both PoC and Nuclei template (fully testable)
- 🔓 **591 CVEs** have PoC but no Nuclei template (testing gap)
- 🦠 **313 CVEs** (20.0%) are known to be used in ransomware campaigns
- 📅 **25 new CVEs** were added in the last 30 days
- 🔒 Most common vulnerability type: **CWE-20** (114 occurrences)
...
| CVE-2025-54253 | Adobe | Experience Manager (AEM)  | 2025-10-15 | ✓ |  |
